...
sudo cp /home/ubuntu/Multi-Tenancy-Application/deploy/nginx/backend.conf /etc/nginx/sites-available/backend
...
sudo cp /home/ubuntu/Multi-Tenancy-Application/deploy/gunicorn.service /etc/systemd/system/
...
echo ""
echo "Next steps:"
echo "1. Edit .env file: nano /home/ubuntu/Multi-Tenancy-Application/backend/.env"
